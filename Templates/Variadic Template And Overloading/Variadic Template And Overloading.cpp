// Variadic Template And Overloading.cpp: определяет точку входа для консольного приложения.
//
...
template<typename ... Types> void Adder(Types...) { } // маркерa розширення

template<typename T > T Get(T&& v) {// маркерa розширення
	return v;
}
